...
1. Lade die aktuelle `.dmg`-Datei von [GitHub Releases](https://github.com/MyEditHub/binky/releases) herunter
2. Öffne die `.dmg`-Datei
3. Ziehe „Binky" in den Programme-Ordner
4. Starte die App — macOS fragt beim ersten Start nach Erlaubnis: **Systemeinstellungen → Datenschutz & Sicherheit → „Trotzdem öffnen"**
...
**Von Philipp & Nadine, für Philipp & Nadine.**
